...
| function | `creep_thick_cylinder_benchmark(*, comm = MPI.COMM_WORLD, radial_cells: int = 4, angular_cells: int = 8, increments: int = 40, duration: float = 1000.0, progress: object = False) -> InelasticStructuralBenchmark` | Run the NAFEMS R0027 Test 7 secondary-creep benchmark. |

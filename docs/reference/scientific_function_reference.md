...
- A displacement-only boundary is not a complete clamp for the rotation-free curvature operator; boundary slope/rotation and conjugate moment semantics remain unavailable.

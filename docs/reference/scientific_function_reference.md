...
| `agentfem.benchmark.delamination_structural_family` | DCB, ENF and MMB structural cohesive verification family | Fixed-path delamination under DCB Mode I, ENF Mode II and MMB mixed-mode loading | assembled_dcb_provider_ci_pending_external_convergence_pending |

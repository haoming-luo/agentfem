...
| Result/data flow | integrated foundation | declarative field/history/diagnostic/presentation plans; compact deformed XDMF/HDF5; projected small-strain S/E/MISES/SENER fields; one structured Standard/Explicit/thermal/J2 event trace; atomic heat/Standard/Explicit checkpoint envelope with accepted-increment cadence; continuation-aware output; mechanical-energy, proportional-static closure, and thermal-balance histories; MPI-safe probes, strong-BC resultants, integrals, and extrema; verification reports and trust-gated learning bridge | affine/weak reactions, non-zero prescribed-displacement work, checkpoint retention, cross-partition restart, and broader conservation balances remain |

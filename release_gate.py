...
REQUIRED_WHEEL_MEMBERS = (
    ...
    "agentfem/origin.json",
    "agentfem/results/core.py",
    "agentfem/results/_analysis_step.py",
    ...
    "agentfem/benchmarks/delamination_fem.py",
    "agentfem/benchmarks/enf_fem.py",
    "agentfem/constitutive/creep.py",
    "agentfem/constitutive/viscoelasticity.py",
    "agentfem/mechanics/harmonic.py",
    "agentfem/mechanics/viscoelasticity.py",
    "agentfem/operators/harmonic.py",
    "agentfem/operators/identity.py",
    "agentfem/dynamics.py",
    ...
    "agentfem/knowledge/benchmarks/delamination_structural_family.json",
    "agentfem/knowledge/benchmarks/linear_cantilever_modal.json",
    "agentfem/knowledge/benchmarks/global_viscoelastic_relaxation.json",
    "agentfem/knowledge/benchmarks/global_viscoelastic_harmonic_bar.json",
    "agentfem/knowledge/benchmarks/nafems_r0016_test5h_forced_vibration.json",
    "agentfem/knowledge/benchmarks/nafems_r0016_test5h_spatial_refinement.json",
    "agentfem/knowledge/benchmarks/abaqus_viscoelastic_rod.json",
    ...
    "agentfem/knowledge/cards/linear_viscoelastic_dynamics.json",
...
SMOKE_COMMANDS = (
    ...
    ("examples/viscoelastic_relaxation_3d.py", ()),
    ("examples/viscoelastic_harmonic_3d.py", ()),

...
# The classes keep their historical ``agentfem.fracture`` public location
# while their implementation belongs to the backend-neutral evidence module.
# The documentation builder reads this literal map without importing FEniCSx.
_DOCUMENTED_REEXPORTS = {
    "CohesiveInterfaceTrace": "fracture_evidence",
    "DynamicFractureEvidenceBundle": "fracture_evidence",
    "ScientificComparison": "fracture_evidence",
}
